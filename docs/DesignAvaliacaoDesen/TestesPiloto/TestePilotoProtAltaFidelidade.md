...
| :----------: | :------: | :-----------: | :---------: |:---------: | :---------: |  
|24/01/2023|24/01/2023|1.0|Criação do Teste Piloto|[Eduardo](https://github.com/edudsan)| [-](https://github.com/) | 
...
necessário para responder as questões levantadas pelo estudo e auxiliar os desenvolvedores na busca de erros ou a falta de clareza no formulário do Planejamento de Avaliação do Protótipo de alta Fidelidade. 
